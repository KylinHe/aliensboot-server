...
java -jar  ${ALIENSBOOT_HOME}/bin/datatool.jar \
-d go -i  ${PROJECT_PATH}/data \
-o ${SRC_PATH}/module/defaultmodule/conf/data.go \
-t ${PROJECT_PATH}/templates/data/go_data.template \
-include 兵种表